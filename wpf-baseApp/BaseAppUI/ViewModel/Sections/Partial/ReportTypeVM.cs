...
{
    public class ReportTypeVM : NotifyProperty
    {
        public Report _parent;
        string _name;
        public string _reporttype;
        bool _isSelected;


        public ReportTypeVM(string name, string reporttype, Report parent)
        {
        ...
        private static void SetIcon(ReportTypeVM vm)
        {
